...
<body>
    ...
    <?php
    $stm=$pdo->prepare("SELECT DISTINCT m.senderID
    FROM 
        message m
    JOIN 
    ...
    <div class="inbox-container">
        ...
        <div class="reply-box">
                <form action="#" method="POST">
                    ...
                    <input hidden type="text" name="receiverID" value="<?php echo $receiverID;?>">
            ...
            <?php
                $stm=$pdo->prepare("SELECT 
                    ...
                    JOIN 
                        message_text mt ON m.messageID = mt.messageID
                    WHERE
                        (m.senderID = 1 AND m.receiverID = $receiverID)
                        OR (m.senderID = $receiverID AND m.receiverID = 1) ORDER BY
            ...
            <div class="content-box">
                ...
                <div class="details">From: <?php if($row['senderID']==1){
                        ...
                        echo customerDetails($receiverID,'firstName')." ".customerDetails($receiverID,'lastName');
                    }?>,
                    <!-- Time Counting -->
                    <?php
