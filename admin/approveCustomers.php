...
?>
<h3 class="h3 mb-3 color-success" >All Registration Completed Customers</h3>
<div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Approval Customers List</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                        <?php
                            $stm=$pdo->prepare("SELECT * FROM customer where stats='Completed'");
                            $stm->execute();
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="confrimModal<?php echo $row['customerID'];?>" tabindex="-1" role="dialog" aria-labelledby="formModal"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <button type="submit" style="float: right;margin-right: 30px;" name="approveCustomer" class="btn btn-success m-t-15 waves-effect">
                                                    Approved
                                                </button>
                                                </form>
                                            </div>
                                    ...
                                    <div class="modal fade" id="deleteModal<?php echo $row['customerID'];?>" tabindex="-1" role="dialog" aria-labelledby="formModal"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-body">
                                                <a href="approveCustomers.php?id=<?php echo $row['customerID']; ?>" type="submit" style="float: right;margin-right: 30px;" name="deleteCustomer" class="btn btn-danger m-t-30 waves-effect">Delete</a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
